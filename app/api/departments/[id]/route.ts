...
export async function GET(
  ...
  try {
    ...
    const department = includeRelations
      ? await departmentService.getDepartmentByIdWithRelations(params.id, context)
      : await departmentService.getDepartmentById(params.id, context);
...
export async function DELETE(
  ...
  try {
    ...
    // Call service
    const department = await departmentService.deleteDepartment(params.id, context);
