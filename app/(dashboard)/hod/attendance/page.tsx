              ...
              <EmptyHeader>
                ...
                <EmptyDescription>
                  {selectedClass !== "Class 9A"
                    ? "No students found for the selected class. Try selecting a different class to view attendance records."
                    : "No students are enrolled in this class yet. Once students are enrolled, you can mark their attendance here."}
                </EmptyDescription>
              </EmptyHeader>
            </Empty>
          )}
