            ...
            {filteredStudents.length > 0 ? (
              ...
              <Empty className="min-h-[400px] border-0">
                <EmptyHeader>
                  ...
                  <EmptyDescription>
                    {searchQuery || classFilter !== "all" || subjectFilter !== "all"
                      ? "No students match your current search or filter criteria. Try adjusting your filters to see more results."
                      : "There is no performance data available yet. Student performance will appear here once assessments are graded."}
                  </EmptyDescription>
                </EmptyHeader>
              </Empty>
            )}
