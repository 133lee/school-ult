                ...
                <EmptyHeader>
                  ...
                  <EmptyDescription>
                    {selectedClass !== "all" || selectedSubject !== "all"
                      ? "No classes match your current filter criteria. Try adjusting your filters to see more schedule entries."
                      : "Your teaching schedule is empty. Schedule entries will appear here once classes are assigned to you."}
                  </EmptyDescription>
                </EmptyHeader>
              </Empty>
            )}
