...
import { studentFormSchema, type StudentFormValues } from "./student-form-schema";
...
export function StudentForm({
  ...
  const form = useForm<StudentFormValues>({
    ...
    defaultValues: {
      ...
      vulnerability: initialData?.vulnerability ?? VulnerabilityStatus.NOT_VULNERABLE,
  ...
  const handleNext = async () => {
    ...
    switch (currentStep) {
      case 1:
        ...
        break;
      case 2:
        fieldsToValidate = ["studentNumber", "admissionDate", "status", "vulnerability"];
        break;
      case 3:
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormItem className="md:col-span-2">
                      ...
                      <FormControl>
                        <Input
                          ...
                          max={new Date(new Date().getFullYear() - 3, 0, 1).toISOString().split("T")[0]}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Date the student was admitted</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value || ""}>
                        ...
                        <SelectContent>
                          <SelectItem value={VulnerabilityStatus.NOT_VULNERABLE}>
                            Not Vulnerable
                          </SelectItem>
                          <SelectItem value={VulnerabilityStatus.ORPHAN}>Orphan</SelectItem>
                          <SelectItem value={VulnerabilityStatus.VULNERABLE_CHILD}>
                            Vulnerable Child
                          </SelectItem>
                          <SelectItem value={VulnerabilityStatus.SPECIAL_NEEDS}>
                            Special Needs
                          </SelectItem>
                          <SelectItem value={VulnerabilityStatus.UNDER_FIVE_INITIATIVE}>
                            Under Five Initiative
                          </SelectItem>
                        </SelectContent>
                      </Select>
                      <FormDescription>Special support or monitoring requirements</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
          ...
          {currentStep === 3 && (
            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="text-lg font-semibold">Contact & Medical Information</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Medical Information <span className="text-muted-foreground text-xs">(Optional)</span>
                      </FormLabel>
                      <FormControl>
                        <Textarea
                      ...
                      <FormDescription>
                        Any medical conditions, allergies, or important health information (max 1000 characters)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          {currentStep === 4 && (
            <div className="space-y-4">
              ...
              <div className="space-y-4 border rounded-lg p-4 bg-muted/30">
                <div>
                  <h4 className="font-semibold text-sm mb-3 text-primary">Personal Information</h4>
                ...
                <div className="border-t pt-4">
                  <h4 className="font-semibold text-sm mb-3 text-primary">Student Details</h4>
                  <dl className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    <div>
                      <dt className="text-muted-foreground font-medium">Student Number:</dt>
                    ...
                    <div>
                      <dt className="text-muted-foreground font-medium">Admission Date:</dt>
                      <dd className="font-semibold mt-1">
                        {form.getValues("admissionDate")?.toLocaleDateString()}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-muted-foreground font-medium">Vulnerability:</dt>
                      <dd className="font-semibold mt-1">
                        {form
                ...
                <div className="border-t pt-4">
                  <h4 className="font-semibold text-sm mb-3 text-primary">Contact & Medical</h4>
                  <dl className="grid grid-cols-1 gap-3 text-sm">
                    ...
                    <div>
                      <dt className="text-muted-foreground font-medium">Medical Info:</dt>
                      <dd className="font-semibold mt-1">
